...
public class longest_k_unique_charcter_count {
    public static void main(String[] args) {
         ...
         * function longestKSubstr() which takes the string S and an integer K as input
         * and returns the length of the longest substring with exactly K distinct
         * characters. If there is no substring with exactly K distinct characters then
         * return -1.
         * 
